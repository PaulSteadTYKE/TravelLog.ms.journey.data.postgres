...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>travellog_journey_dev_schema</code>.
     */
    public final TravellogJourneyDevSchema TRAVELLOG_JOURNEY_DEV_SCHEMA = TravellogJourneyDevSchema.TRAVELLOG_JOURNEY_DEV_SCHEMA;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            TravellogJourneyDevSchema.TRAVELLOG_JOURNEY_DEV_SCHEMA
        );
    }
